...
assert.equal((additional.match(/<w14:checked w14:val="1"\/?>/g) ?? []).length, 1, 'Somente a origem administrativa selecionada deve vir marcada; a decisão do cliente deve permanecer vazia');
