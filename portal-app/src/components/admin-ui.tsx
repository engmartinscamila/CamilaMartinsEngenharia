...
const styleDefinitions = (colors: ThemeColors) => ({
  ...
  navigationMenu: { width: '100%', gap: spacing.xs },
  headerActions: { width: '100%', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm },
