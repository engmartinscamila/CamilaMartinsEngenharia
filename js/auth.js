...
AUTENTICAÇÃO — compatível com Cloudflare Pages
=====================================================
*/
...
function paginaAtual() {
    ...
    let pagina = caminho.split("/").pop() || "index.html";

    // O Cloudflare Pages publica URLs limpas:
    // /login -> login.html, /admin -> admin.html, /portal -> portal.html etc.
    // Internamente normalizamos para o nome físico do arquivo, evitando
    // loops entre /login e /login.html.
    if (!pagina.includes(".")) {
        pagina += ".html";
    }
